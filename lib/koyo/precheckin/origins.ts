...
export const PRECHECKIN_ORIGINS: Record<string, Origin> = {
  // 山形駅（JR山形新幹線・奥羽本線）
  A: { name: "山形駅", lat: 38.24872184482033, lng: 140.3274855054493 },
  B: { name: "山形空港", lat: 38.4125, lng: 140.3711 },
  // かみのやま温泉駅（JR奥羽本線）
  C: { name: "かみのやま温泉駅", lat: 38.152354161541865, lng: 140.2786369621144 },
  // 山形蔵王IC
  D: { name: "山形蔵王IC", lat: 38.245687397024604, lng: 140.38120536709008 },
  // かみのやま温泉IC
  E: { name: "かみのやま温泉IC", lat: 38.12674996908368, lng: 140.2565646800433 },
};
